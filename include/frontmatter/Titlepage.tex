...
\includegraphics[height=0.7\linewidth]{figure/Arles_Townhall.jpg}
\end{figure}
...
Master's thesis in Master Structural Engineering and Building Technology \setlength{\parskip}{1cm}
